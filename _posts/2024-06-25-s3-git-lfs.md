...
![Storage issues with LFS](/assets/images/posts/s3-git-lfs/LFSproblems.png)
...
![Terraform plan output step 1](/assets/images/posts/s3-git-lfs/TFplan1.png)

![Terraform plan output step 2](/assets/images/posts/s3-git-lfs/TFplan2.png)

![Terraform plan output step 3](/assets/images/posts/s3-git-lfs/TFplan3.png)

![Terraform plan output step 4](/assets/images/posts/s3-git-lfs/TFplan4.png)
...
![Terraform apply password output](/assets/images/posts/s3-git-lfs/applyPassword.png)
...
1. Disable GitLab LFS in the GitLab project settings to ensure no new files are uploaded to GitLab's LFS.
  ...
  ![GitLab LFS settings](/assets/images/posts/s3-git-lfs/gitlabScreenshot.png)
