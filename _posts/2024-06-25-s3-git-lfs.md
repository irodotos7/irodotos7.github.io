...
![Storage issues with LFS]({{ '/assets/images/posts/LFSproblems.png' | relative_url }})
...
![Terraform plan output step 1]({{ '/assets/images/posts/TFplan1.png' | relative_url }})

![Terraform plan output step 2]({{ '/assets/images/posts/TFplan2.png' | relative_url }})

![Terraform plan output step 3]({{ '/assets/images/posts/TFplan3.png' | relative_url }})

![Terraform plan output step 4]({{ '/assets/images/posts/TFplan4.png' | relative_url }})
...
![Terraform apply password output]({{ '/assets/images/posts/applyPassword.png' | relative_url }})
...
1. Disable GitLab LFS in the GitLab project settings to ensure no new files are uploaded to GitLab's LFS.
  ...
  ![GitLab LFS settings]({{ '/assets/images/posts/gitlabScreenshot.png' | relative_url }})
